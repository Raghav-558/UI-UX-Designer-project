  ...
  return (
    <div className='bg-black'>
      <div className='max-w-[1140px] mx-auto px-4 pt-16 max-md:pt-10 pb-16 max-md:pb-10 max-lg:px-4'>
        ...
        <div className='flex flex-wrap flex-row -mx-3 pt-14 max-sm:pt-6'>
          {CARDS.slice(0, show).map((obj, index) => (
            <div key={index} className='w-full md:w-1/2 lg:w-1/3 px-3'>
              <a href="#">
                <div className='bg-white rounded-xl p-2 transition-all duration-300 mb-6 hover:scale-[1.01]'>
                  <img src={obj.img} alt={obj.title} className='rounded-xl w-full' />
                  <div className='p-3'>
