  ...
  return (
    <div id='work' className='bg-black'>
      <div className='max-w-[1140px] mx-auto px-5 pt-16 max-md:pt-10 pb-16 max-md:pb-10'>
        <div data-aos="fade-down" className='text-left flex items-center gap-16 max-sm:flex-col max-sm:gap-3'>
          <h2 className='font-eczar font-semibold text-fs-2xl max-md:text-3xl text-white'>Featured Work</h2>
