                ...
                <div className='flex flex-wrap flex-row -mx-3 items-center'>
                    <div data-aos="fade-down" className='w-full lg:w-1/2 px-3'>
                        <div className='max-lg:pt-10 '>
                            <h2 className='font-eczar text-fs-2xl font-semibold text-white max-sm:text-3xl'>A Little Bit About Me</h2>
                            <p className='font-normal text-xl leading-7 text-white font-worksans max-sm:text-base max-sm:leading-6 pt-2'>Neque lectus elit massa aenean turpis quam aliquet.Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque ipsum, scelerisque proin consequat tristique tortor, amet nullam. Eu purus blandit luctus faucibus justo venenatis a. </p>
