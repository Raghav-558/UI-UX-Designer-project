                    ...
                    <div className='w-full lg:w-6/12 px-3'>
                        <div>
                            ...
                            <div className='flex mt-8 max-sm:mt-5 items-center gap-4 worksans max-sm:flex-col max-sm:gap-3'>
                                <button className='max-md:text-base px-6 py-4 worksans bg-black btn-1-pd rounded-md border-4 border-black hover:bg-white group/icon text-white text-xl font-semibold whitespace-nowrap flex items-center gap-3 hover:text-black transition-all duration-300' >
                                    View My Work
