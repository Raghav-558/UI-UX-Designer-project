            ...
            <div className='container max-w-[1140px] px-3 mx-auto mt-12 mb-124'>
                <div className='flex flex-wrap flex-row -mx-3 justify-between items-center'>
                    <div className='w-full lg:w-6/12 px-3'>
                        <div>
                            <button className='px-6 py-3 bg-black text-white rounded-[10px] text-fs-md work-sans'>👋 Hello All</button>
                            <h2 className='text-fs-4xl text-customBlack font-semibold eczar pt-6 leading-[80px]'>
                                I’m Chiranjit H,
                                A UI/UX Designer
                                and Developer
                            </h2>
                            <div className='flex mt-10 items-center gap-4 work-sans max-md:flex-col max-md:gap-5'>
                                ...
                                <button className='btn-2-pd bg-white border-4 border-black rounded-md text-fs-sm font-semibold text-customlightgray whitespace-nowrap hover:bg-black hover:text-white transition-all duration-300'>Contact Me</button>
                            </div>
                        </div>
                    </div>
