...
const Herosection = () => {
    return (
        <div className='flex items-center flex-col'>
            ...
            <div className='container max-w-[1140px] px-3 mx-auto mt-12 mb-28'>
                <div className='flex flex-wrap flex-row -mx-3 justify-between items-center'>
                    <div className='w-full lg:w-6/12 px-3'>
                        <div>
                            <button className='px-6 py-3 bg-black text-white rounded-[10px] text-2xl worksans'>👋 Hello All</button>
                            ...
                            <div className='flex mt-10 items-center gap-4 worksans max-md:flex-col max-md:gap-5'>
                                <button className='px-6 py-4 worksans bg-black btn-1-pd rounded-md border-4 border-black hover:bg-white group/icon text-white text-xl font-semibold whitespace-nowrap flex items-center gap-3 hover:text-black transition-all duration-300' >
                                    View My Work
